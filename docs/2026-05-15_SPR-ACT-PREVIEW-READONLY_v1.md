...
## Validação
- **Backend:** Suite de testes expandida para 114 testes, cobrindo ataques de traversal via companion, escape de fronteira, normalização de índices de frame/action e falhas de renderização seguras.
